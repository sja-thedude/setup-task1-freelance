...
import { addCloseDetail } from '@/redux/slices/cartSlice'

export default function BackButton(props: any) {
    const { id, handleCloseMobilePopup } = props
    const closeDetail = useAppSelector<any>((state: any) => state.cart.closeDetail);
