...
function UserWebsiteDetail(props?: any) {
    let {
        isLoadingProduct,
            ...
            {isLoadingProduct === false && isLoadingProductOptions === false && (
                <div>
                    ...
                    <div className={`${style['product-detail']} overflow-hidden`}>
                        <div className="row ps-2 pe-2">
                            <div className="col-sm-12 col-xs-12 d-flex">
                                <div className="float-start">
                                    <h1 className={`${style['product-title']} word-break mt-3`}>
                                        {product?.data?.name}
                                    </h1>
                                </div>
                        ...
                        <div className="row ps-2 pe-2">
                            <div className="col-sm-12 col-xs-12">
                                <p className={`${style['product-description']} word-break`}>{product?.data?.description}</p>
                            </div>
                        </div>
                        <div className="row ps-2 pe-2">
                            <div className="col-sm-12 col-xs-12">
                        ...
                        <TypesPopup workspace={workspace} handleCloseMobilePopup={handleClose} />
                    </div>
                </div>
            )}
        </>
...
export default memo(UserWebsiteDetail)