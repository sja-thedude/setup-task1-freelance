...
export default function IntroTables() {
    ...
    useEffect(() => {
        if (onclickBack) {
            ...
            if (query.get('categoryCart') === 'true') {
    ...
    const handlePasswordChange = (e: any) => {
        const { value } = e.target;
        setPassword(value);
        setPasswordFilled(value.length > 0);
    };
        ...
        <>
            {
                workspaceId ? (
                    <div className='container'>
                        <div className={`${variables.login} row justify-content-center`} style={{ backgroundColor: apiData ? apiData?.primary_color : 'white', height: '100%' }}>
                        <div style={{ position: "absolute", top: "20px" }} onClick={() => { setOnclickBack(true) }}>
                            ...
                            <div className={`col-md-6 d-flex justify-content-center mt-4`}>
                                <Image
                                    alt='intro'
                                    src={apiPhoto ? apiPhoto : '/img/belgium-flag-icon.svg'}
                                    width={128}
                                    height={127}
                                    sizes="100vw"
                            ...
                            <div className="col-8 text-center ps-2 pe-2 mt-3">
                                <h1 className={welcome}>{apiDataToken?.data && apiDataToken?.data?.setting_generals?.title ? trans('title') + ' ' + apiDataToken?.data?.setting_generals?.title : ''}</h1>
                            </div>
                            <div className="row text-center ps-3 pe-3 mb-2">
                                <h1 className={introduce}> {trans('login-title')}</h1>
                            </div>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className={`${variables.input}`}>
                                        <input
                                            type="text"
                                            autoCapitalize="off"
                                            className={`${customInput} ${isEmailValid ? '' : invalid} form-control`}
                                            id="email"
                                    ...
                                    <div>
                                        <div className="input-group">
                                            <input
                                                ...
                                                className={`${customInput} ${isPasswordValid ? '' : invalid} form-control`}
                                                id="password"
                                            ...
                                            />
                                            <button
                                                className={`${eye} ${isPasswordValid ? '' : invalid} btn`}
                                                type="button"
                                            ...
                                            >
                                                {isPasswordVisible ? (
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1 12.5C1 12.5 5 4.83334 12 4.83334C19 4.83334 23 12.5 23 12.5C23 12.5 19 20.1667 12 20.1667C5 20.1667 1 12.5 1 12.5Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                        <path d="M12 15.375C13.6569 15.375 15 14.0878 15 12.5C15 10.9122 13.6569 9.625 12 9.625C10.3431 9.625 9 10.9122 9 12.5C9 14.0878 10.3431 15.375 12 15.375Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                        <line x1="5.378" y1="1.318" x2="19.318" y2="23.622" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                ) : (
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1 15C1 15 5 7 12 7C19 7 23 15 23 15C23 15 19 23 12 23C5 23 1 15 1 15Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                        <path d="M12 18C13.6569 18 15 16.6569 15 15C15 13.3431 13.6569 12 12 12C10.3431 12 9 13.3431 9 15C9 16.6569 10.3431 18 12 18Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                )}
                                            </button>
                                        </div>
                                    ...
                                    <div className="row justify-content-center mt-3" style={{ paddingRight: '12px' }}>
                                        ...
                                        <div className="col-sm-5 col-5 d-flex justify-content-center text-center">
                                            <a className={forget} href="/user/reset_password" style={{ textDecoration: 'none', color: 'white', textTransform: 'uppercase' }}>{trans('forget-password')}</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div className={`${line} ps-4 pe-4 text-center mt-2`}>
                                ...
                                <span style={{ marginTop: '5px' }}>{trans('of')}</span>
                                &nbsp;&nbsp;<span className={`${dashLine}`}></span>
                            </div>
                        ...
                        <div className="row text-center d-flex justify-content-center" style={{ backgroundColor: '#413E38' }}>
                            <div className={`${content} d-flex flex-column align-items-center justify-content-center`} style={{ backgroundColor: '#322F28' }}>
                                <Link href={'/user/register'} style={{ textDecoration: 'none', color: 'white' }}>{trans('register')}</Link>
                            </div>
                            <div className={`${nunet} mt-2`} onClick={() => router.back()}>
                                {trans('not-now')}
                            </div>
                            <div className={`${copy}`}>
                                <Link className={`${term}`}
