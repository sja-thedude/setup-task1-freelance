...
export default function Register() {
    ...
    return (
        <>
            <div className='row' style = {{backgroundColor: workspaceId ? color : '#B5B268'}}>
                ...
                <div className={`${variables.title} row mb-2 mt-1`} style={{paddingLeft:'25px', paddingRight: '25px'}}><p>{trans('register-check')}</p></div>
