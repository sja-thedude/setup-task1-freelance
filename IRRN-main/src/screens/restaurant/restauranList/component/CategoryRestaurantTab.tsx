...
const CategoryRestaurantTab: FC<IProps> = ({ restaurantData, currentOrderType, refreshing, handleRefresh, animatedValue }) => {
    ...
    const renderItem = useCallback(({ item } : {item: any}) => {
        if (item.type === ITEM_TYPE.HEADER) {
            ...
            return (
                <View style={{ backgroundColor: themeColors.color_app_background }}>
    ...
    }, [currentOrderType, styles.sectionText, themeColors.color_app_background, themeColors.color_common_description_text]);
...
export default memo(CategoryRestaurantTab);
