...
export interface Props {
    ...
    children: ReactNode | ReactElement<any> | Array<ReactNode | ReactElement<any>>
    controller?(_ref: ExpandableTextInterface): void
    onChange?(_prop: OnChangeInterface): void
    onReady?(_prop: OnReadyInterface): void
}
...
export class ExpandableTextComponent extends PureComponent<Props, State>
