...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | @link https://packagist.org/packages/alariva/laravel-email-domain-blacklist
    |
    ...
    */
    ...
    'email' => [
        ...
        'blacklist' => [
            ...
            'source' => null, //'https://raw.githubusercontent.com/ivolo/disposable-email-domains/master/index.json',

            'cache-key' => 'email.domains.blacklist',

            'auto-update' => false,

            'append' => 'zol.be|zmk.be',
