...
class CreateRewardRequest extends Request
{
    ...
    {
        return [
            'title.required'             => trans('common.validation.field_required'),
            'type.required'              => trans('common.validation.field_required'),
            'score.required'             => trans('common.validation.field_required'),
            'reward.required'            => trans('common.validation.field_required'),
            'description.required'       => trans('common.validation.field_required'),
            'expire_date_valid.required' => trans('common.validation.field_required'),
    ...
    public function prepareForValidation()
    {
        ...
        if ($this->has('expire_date')) {
            $inputSwitch['expire_date_valid'] = Carbon::parse($this->expire_date)->format('Y-m-d H:i');
        }
