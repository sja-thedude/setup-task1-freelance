...
class CreateGroupRequest extends Request
{
    ...
    {
        return [
            'name.required'             => trans('common.validation.field_required'),
            'company_street.required'   => trans('common.validation.field_required'),
            'company_number.required'   => trans('common.validation.field_required'),
            'company_postcode.required' => trans('common.validation.field_required'),
            'company_city.required'     => trans('common.validation.field_required'),
            'close_time.required'       => trans('common.validation.field_required'),
            'receive_time.required'     => trans('common.validation.field_required'),
            'contact_email.required'    => trans('common.validation.field_required'),
            'contact_surname.required'  => trans('common.validation.field_required'),
            'contact_name.required'     => trans('common.validation.field_required'),
            'contact_gsm.required'     => trans('common.validation.field_required'),
            ...
            'discount_type.required'     => trans('common.validation.field_required'),
