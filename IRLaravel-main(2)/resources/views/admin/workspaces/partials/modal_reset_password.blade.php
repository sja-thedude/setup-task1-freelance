<!-- Modal -->
<div id="modal_reset_password_{!! $workspace->id !!}" class="modal fade" role="dialog">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <a class="ir-btn ir-btn-primary call-ajax full-width inline-block text-center"
                           data-route="{!! route($guard.'.restaurants.sendInvitation', [!empty($workspace->userManager) ? $workspace->userManager->id : 0]) !!}"
                           data-id="{{!empty($workspace->userManager) ? $workspace->userManager->id : 0}}"
                           data-method="post">
