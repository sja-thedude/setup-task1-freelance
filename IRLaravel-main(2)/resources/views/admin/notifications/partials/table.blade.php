<div class="list-responsive list-responsive-small">
    <div class="list-header">
        <div class="row">
            <div class="col-item col-sm-2 col-xs-12">
                <a href="{{Helper::getFullSortUrl('title')}}">
                    @lang('notification.label_title') {{Helper::getIconSort('title')}}
                </a>
            </div>
            <div class="col-item col-lg-7 col-sm-4 col-xs-12">
                <a href="{{Helper::getFullSortUrl('description')}}">
                    @lang('notification.label_description') {{Helper::getIconSort('description')}}
                </a>
            </div>
            <div class="col-item col-lg-1-5 col-sm-3 col-xs-12 text-right">
                <a href="{{Helper::getFullSortUrl('send_datetime')}}">
                    @lang('notification.sent_time') {{Helper::getIconSort('send_datetime')}}
                </a>
            </div>
