...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <!-- NProgress -->
    <link href="{{URL::to('/')}}/assets/nprogress/nprogress.css" rel="stylesheet">
    <!-- jQuery custom content scroller -->
    <link href="{{URL::to('/')}}/assets/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
