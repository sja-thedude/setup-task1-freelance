<!-- Modal -->
<div id="modal_edit_printer_group_{{$group->id}}" class="ir-modal modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-detail">
                    {!! Form::model($group, [
                        'route' => [$guard.'.printergroup.update',
                        $group->id],
                        'method' => 'patch',
                        'files' => true,
                        'class' => 'update-form',
                    ...
                    <div class="row">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8 col-xs-12">
                                {!! Form::text('name', $group->name, ['class' => 'form-control', 'required' => 'required', 'placeholder' => trans('printer_group.name')]) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8 col-xs-12">
                                {!! Form::textarea('description', $group->description, ['class' => 'form-control', 'required' => 'required', 'placeholder' => trans('strings.banner.label_description')]) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8 col-xs-12">
                                @php
                                    $existIds = $group->printerGroupWorkspaces->pluck('id')->all();
                                    $exists = $group->printerGroupWorkspaces->pluck('name', 'id')->all();
                                    $avaiRestaurantIds = \App\Facades\Helper::printerGroupAvaiWorkspaces($restaurants, $exists);
                                @endphp
                                {!! Form::select('restaurants[]', $avaiRestaurantIds, $existIds, [
                                'id' => 'restaurants',
