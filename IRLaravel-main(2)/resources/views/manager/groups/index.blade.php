...
@section('content')
    <div class="row layout-manager products options groups">
        <div class="col-md-12">
            <div class="ir-panel">
                <div class="ir-title">
                    <h2 class="ir-h2">
                ...
                <div class="search-and-button">
                    <ul class="nav navbar-left panel_toolbox">
                        <li>
                            @include($guard.'.groups.partials.quick_search')
                        </li>
                    </ul>
                    <ul class="nav navbar-right panel_toolbox">
                        <li>
                            <a data-route="{!! route('manager.groups.create') !!}"
                               class="ir-btn ir-btn-primary btnCreate">
                                <i class="ir-plus"></i> @lang('group.add')
                            </a>
                        </li>
                    </ul>
                ...
                <div class="ir-content">
                    @include('manager.groups.partials.table')
                    <br><br><br>
                </div>

                @include('manager.groups.partials.modal')
            </div>
        </div>
    </div>
@endsection
