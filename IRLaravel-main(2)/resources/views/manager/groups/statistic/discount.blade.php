        ...
        <div class="col-md-12">
            <div class="ir-panel">
                <div class="ir-title">
                    ...
                    <p class="statistic-sub-title mgb-0">@lang('statistic.discount')</p>
                </div>
                <div class="main-content">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            @include('manager.groups.statistic.partials.search', [
                                'route' => [$guard.'.groups.statistic.discount', $group->id],
                                'dateIp' => true,
                                'searchIp' => true
                            ])
                    ...
                    <div id="statistic-list" >
                        @if(empty($autoloadAjax))
                            @include('manager.groups.statistic.partials.discount_table')
                        @endif
                    </div>
                </div>
            </div>
