<fieldset class="list-item-none {{$field}}-default-row" disabled="disabled" style="display: none;">
    {!! Form::hidden('id', 0) !!}
    ...
    <div class="col-md-5">
        <div class="form-group form-with-text">
            ...
            <span class="mgr-8">
                <input type="checkbox" name="auto" id="print-auto" 
                   class="switch-input auto-submit" 
                   data-type="print"/>
                <label for="print-auto" class="switch mg-0"></label>
            </span>
        </div>
    </div>
</fieldset>