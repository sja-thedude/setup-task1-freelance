<!-- Modal -->
<div id="upload-galleries" class="ir-modal dropzone-box modal fade" data-gallery="{{\App\Models\Media::GALLERIES}}" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3>{{trans('setting.general.galleries')}}</h3>
                <div class="dropzone-manual">
                    ...
                    <div class="gridly row" data-route="{{route($guard . '.settings.updateGalleryOrder', [$tmpWorkspace->id])}}">
                        @php
                            $workspaceGalleries = $tmpWorkspace->workspaceGalleries->sortBy('order');
                        @endphp
                        @foreach ($workspaceGalleries as $image)
