                            ...
                            @foreach($perProducts as $catId => $item)
                                @if(!empty($item))
                                    @php
                                        ...
                                        $totalInclDiscount = $totalInclDiscount + (!empty($item['cat_price'] && $item['cat_price'] > 0) ? $item['cat_price'] : 0);
                                    @endphp
                                    ...
                                    <div class="wrap-collapse">
                                        <div class="row row-statistic row-cat collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse-{{$catId}}" aria-expanded="false" aria-controls="collapse-{{$catId}}">
                                            ...
                                            <div class="col-item col-sm-4 col-xs-12 text-center">
                                                <span>{!! $currency !!}{!! (!empty($item['cat_price']) && $item['cat_price'] > 0) ? $item['cat_price'] : 0 !!}</span>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-sm-12 col-xs-12">
                                                    @foreach($products as $product)
                                                        <div class="row row-statistic">
                                                            ...
                                                            <div class="col-item col-sm-4 col-xs-12 text-center">
                                                                <span class="font-w-normal">{!! $currency !!}{!! (!empty($product['product_price']) && $product['product_price'] > 0) ? $product['product_price'] : 0 !!}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
