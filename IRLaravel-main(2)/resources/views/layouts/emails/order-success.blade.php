@php
\App::setLocale($userLocale ?? \App::getLocale());
@endphp
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <tr>
                            <td style="{{ $style['email-body'] }}" width="100%">
                                <div style="padding:50px">
                                    ...
                                    @if(in_array($cart->type, [
                                        \App\Helpers\OrderHelper::TYPE_DELIVERY
                                    ]))
                                        <p>{!! $content12 !!}</p>
                                    @elseif($cart->isBuyYourSelf())
                                    ...
                                    <div class="shopping-cart">
                                        ...
                                        <div class="shopping-cart">
                                            ...
                                            <div class="wp-table table-order">
                                                ...
                                                @if (!is_null($cart->ship_price) || !empty($cart->service_cost) || !is_null($cart->coupon_discount) || !is_null($cart->redeem_history_id))
                                                ...
                                                @if ($cart->type == \App\Helpers\OrderHelper::TYPE_DELIVERY)
                                                    <div class="wrapForProduct no-border-bottom">
                                                        <div class="row-table" style="display:flex">
                                                            <div class="col-left" style="width:50%;text-align:left">
                                                                <b class="extra">
