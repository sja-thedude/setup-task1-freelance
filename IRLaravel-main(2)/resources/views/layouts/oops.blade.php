...
<head>
    ...
    <!-- Custom Theme Style -->
    @stack('style-top')
    <link href="{{ URL::to('/builds/css/vendor.web.css') }}" rel="stylesheet">
    <link href="{{ URL::to('/builds/css/main-core.web.css') }}" rel="stylesheet">
    <link href="{{ URL::to('/builds/css/main.web.css') }}" rel="stylesheet">
...
<body class="body homepage web-portal">
@include('web.home.oops_header')

<main class="oops main-content">
    @yield('content')
</main>
...
<script src="{{ URL::to('/builds/js/vendor.web.js') }}"></script>
<script src="{{ URL::to('/builds/js/main.web.js') }}"></script>
