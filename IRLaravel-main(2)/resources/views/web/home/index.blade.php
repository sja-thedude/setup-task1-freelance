...
@section('slider')
    <div class="hp-slider">
        ...
        <div class="wp-content pl-35 home" id="wrapSwitchAfhaalLevering" style="{{ session()->has('address_not_avaliable') ? "display:none" : "margin-left:-500px; display: none;" }}">
            <div class="row">
                <div class="col-md-12">
                    @if($is_takeout)
                    ...
                    <div class="row pl-35">
                        <div class="col-md-12">
                            <div class="wrap-action">
                                <a href="javascript:;" class="backStep mb-30 dark-grey font-18" style="display:inline-block" data-step="1">
            ...
            {!! Form::open(['route' => ['web.cartAddress.store', $categoryId], 'name' => 'order', 'method' => 'POST', 'class' => 'step-order']) !!}
                ...
                <div class="wrap-step active" data-id="1">
                    <div class="row pl-35">
                        ...
                        <div class="clearfix"></div>
                        <div class="col-xs-custom col-md-3">
                            <div class="form-line">
                                <div class="form-input">
                                    <input id="keyword-search-groups" data-route="{{ route('web.groups.index') }}" class="font-18"
...
@if(!empty(request()->get('address_unknown', 0)))
    @push('scripts')
        <script>
            $(document).ready(function () {
                var btnLevering = $('.btnLevering');
                var mBtnLevering = $('.mBtnLevering');

                if(btnLevering.length) {
                    btnLevering.trigger('click');
                    mBtnLevering.trigger('click');

                    setTimeout(function(){
                        btnLevering.closest('#wrapSwitchAfhaalLevering').hide();
                        mBtnLevering.closest('#wrapMSwitchAfhaalLevering').hide();
                    },1600);
                }
            });
        </script>
