<header class="container-fluid new-home oops" >
            ...
            <nav class="navbar navbar-inverse">
                ...
                <div class="collapse navbar-collapse menu" id="navbarNavAltMarkup">
                    <ul class="nav navbar-nav mr-auto mt-2 mt-lg-0">
                        <li class="nav-item"><a href="{{route('web.index')}}" class="nav-link">{{trans('dashboard.home')}}</a></li>
                        <li class="nav-item"><a href="{{ Url('/') }}/{{App::getLocale()}}/how-does-it-work.html" class="nav-link">{{trans('dashboard.how_does_it_work')}}</a></li>
                        <li class="nav-item"><a href="{{route('web.search_restaurant')}}" class="nav-link">{{trans('dashboard.find_merchants')}}</a></li>
                                    ...
                                    <ul class="sub-menu sub-menu-email sub-menu-time sub-order-history">
                                        @foreach($orderLists as $order)
                                            ...
                                            <li>
                                                ...
                                                <a href="javascript:;" class="btn btn-andere order-detail btn-pr-custom"
